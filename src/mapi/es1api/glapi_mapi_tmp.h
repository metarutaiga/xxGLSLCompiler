...
void APIENTRY gl_dispatch_stub_1409(void);
void APIENTRY gl_dispatch_stub_1410(GLfloat minX, GLfloat minY, GLfloat minZ, GLfloat minW, GLfloat maxX, GLfloat maxY, GLfloat maxZ, GLfloat maxW);
